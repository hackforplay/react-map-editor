...
const Eraser3 = (props: React.SVGAttributes<SVGElement>) => (
  ...
  >
    <defs>
      <path id="eraser_3_svg__a" d="M0 .18h41.357v36.187H0z" />
      <path id="eraser_3_svg__c" d="M0 37h47.879V1H0z" />
    </defs>
    <g fill="none" fillRule="evenodd">
      <path d="M0 0h48v48H0z" />
      <g transform="translate(0 5)">
        <g transform="translate(0 .82)">
          <mask id="eraser_3_svg__b" fill="#fff">
            <use xlinkHref="#eraser_3_svg__a" />
          </mask>
          <path
            ...
            fill="currentColor"
            mask="url(#eraser_3_svg__b)"
          />
        </g>
        <mask id="eraser_3_svg__d" fill="#fff">
          <use xlinkHref="#eraser_3_svg__c" />
        </mask>
        <text
          mask="url(#eraser_3_svg__d)"
